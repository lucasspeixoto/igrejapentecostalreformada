...
import { isSecretaryGuard } from './is-secretary.guard';

describe('isSecretaryGuard', () => {
  const mockNavigateByUrl = vi.fn();
  const mockIsUserAdmin = vi.fn();
  const mockIsUserSecretary = vi.fn();
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            isUserSecretary: mockIsUserSecretary,
          },
        },
        {
          provide: Router,
  ...
  it('should allow access when user is admin', async () => {
    ...
    const result = await TestBed.runInInjectionContext(() => isSecretaryGuard(null as never, null as never));
  ...
  it('should call isUserAdmin on the repository', async () => {
    ...
    await TestBed.runInInjectionContext(() => isSecretaryGuard(null as never, null as never));
