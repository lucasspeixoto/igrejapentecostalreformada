    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">
                ...
                Angular v19 with PrimeNG v19. In case CLI is not installed already, use the command below to set it up.
            </p>
            <pre class="app-code">
<code>npm install -g &#64;angular/cli</code></pre>
            ...
            <pre class="app-code">
<code>git clone https://github.com/primefaces/igrejapentecostalreformada
npm install
ng serve</code></pre>
