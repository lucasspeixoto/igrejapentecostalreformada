...
import type { TopFinanceNoteByCategory } from '../../../../../domain/models/finance-note.model';
  ...
  template: `
    <li class="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
      ...
      <div class="mt-2 md:mt-0 flex items-center">
        ...
        <span class="text-primary ml-4 font-bold">%{{ topFinanceNoteByCategory.percent.toFixed(2) }}</span>
      </div>
    </li>
  `,
  styles: ``,
})
export class CategoryNoteDetail {
