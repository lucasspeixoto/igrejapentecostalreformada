...
@Component({
  selector: 'app-ed-course-image-upload',
  templateUrl: './ed-course-image-upload.component.html',
  imports: [FileUpload, ToastModule, CommonModule],
  providers: [MessageService],
})
export class EdCourseImageUploadComponent {
  ...
  public onUpload(event: FileUploadHandlerEvent): void {
    ...
    reader.onload = (e): void => {
      this.fileUploadService.uploadedCourseImage.set(e.target?.result as string);
