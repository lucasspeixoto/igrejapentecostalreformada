...
@Component({
  ...
  template: `<div class="card !mb-8">
    ...
    <span class="block text-muted-color font-medium mb-4">18/04/2025</span>
      ...
      <li class="flex items-center py-2 border-b border-surface">
        ...
        <span class="text-surface-900 dark:text-surface-0 leading-normal"
          ...
          <span class="text-surface-700 dark:text-surface-100">
            culto especial de pascoa neste <span class="text-primary font-bold">domingo</span></span
          >, não percam.
        </span>
      </li>
    </ul>

    <span class="block text-muted-color font-medium mb-4">14/04/2025</span>
